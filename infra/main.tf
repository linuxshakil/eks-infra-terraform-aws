...
#
# This module deliberately runs *after* the EKS module. On
# GKE this kind of split wasn't necessary because the Workload
# Identity Pool was a project-level thing, independent of any
# one cluster. On EKS, the OIDC provider is generated by the
# cluster itself, so workload IAM roles can only be created
